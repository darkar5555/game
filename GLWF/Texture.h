...
public:
    ...
    static GLuint LoadCubemap( std::vector<const GLchar * > faces)
    {
        ...
        glTexParameteri( GL_TEXTURE_BINDING_CUBE_MAP , GL_TEXTURE_MAG_FILTER, GL_LINEAR );
        glTexParameteri( GL_TEXTURE_BINDING_CUBE_MAP , GL_TEXTURE_MIN_FILTER, GL_LINEAR );
        glTexParameteri( GL_TEXTURE_BINDING_CUBE_MAP , GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE );
        glTexParameteri( GL_TEXTURE_BINDING_CUBE_MAP , GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE );
        glTexParameteri( GL_TEXTURE_BINDING_CUBE_MAP , GL_TEXTURE_WRAP_R, GL_CLAMP_TO_EDGE );
        glBindTexture( GL_TEXTURE_BINDING_CUBE_MAP , 0);
